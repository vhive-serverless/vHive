...
require (
	...
	github.com/ustiugov/fccd-orchestrator/memory/manager v0.0.0-20200811132642-8b3089551907
	...
	github.com/ustiugov/fccd-orchestrator/taps v0.0.0-20200810131438-c33d4fc5646a // indirect
