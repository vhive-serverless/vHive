...
do
	...
	time sudo docker pull ghcr.io/ease-lab/helloworld:var_workload
	echo -e "pyaes pull  $i: \n" >> log_master_script.txt
	time sudo docker pull ghcr.io/ease-lab/pyaes:var_workload
  echo -e "rnn pull  $i: \n" >> log_master_script.txt
	time sudo docker pull vhiveease/rnn_serving:var_workload
