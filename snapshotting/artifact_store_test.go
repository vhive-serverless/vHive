...
func TestArtifactKeySchemesRejectAmbiguousParts(t *testing.T) {
	...
	chunkKey, err := chunkArtifactKey(chunkID([]byte("page")))
	require.NoError(t, err)
	require.Equal(t, ArtifactKey("shared/chunks/36/3660315a9af3df255d8f19ab077e4797822b41488a0e2a04bc6af71213c23274"), chunkKey)
