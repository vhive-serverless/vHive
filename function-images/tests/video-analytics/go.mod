...
replace (
	github.com/ease-lab/vhive-xdt/proto/downXDT => github.com/ease-lab/vhive-xdt/proto/downXDT v0.0.0-20210725191809-e5abcf4f3ca6
...
require (
	...
	github.com/ease-lab/vhive-xdt/sdk/golang v0.0.0-20210725191809-e5abcf4f3ca6
