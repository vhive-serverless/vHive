...
type TimeseriesClient interface {
	...
	// Timeseries CloudEvent Relay methods
	// =====================================
	RegisterEvent(ctx context.Context, in *Event, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *timeseriesClient) RegisterEvent(ctx context.Context, in *Event, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/Timeseries/RegisterEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TimeseriesServer interface {
	...
	// Timeseries CloudEvent Relay methods
	// =====================================
	RegisterEvent(context.Context, *Event) (*empty.Empty, error)
...
func (UnimplementedTimeseriesServer) RegisterEvent(context.Context, *Event) (*empty.Empty, error) {
...
func _Timeseries_RegisterEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Event)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TimeseriesServer).RegisterEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Timeseries/RegisterEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TimeseriesServer).RegisterEvent(ctx, req.(*Event))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Timeseries_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Timeseries_RegisterEvent_Handler,
		},
	},
