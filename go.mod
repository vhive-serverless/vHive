...
require (
	...
	github.com/ustiugov/fccd-orchestrator/ctriface v0.0.0-20200802133455-7f6a9605bef8
	github.com/ustiugov/fccd-orchestrator/helloworld v0.0.0-20200717125634-528c6e9f9cc9
	github.com/ustiugov/fccd-orchestrator/metrics v0.0.0-20200802105459-13bf7342a187
